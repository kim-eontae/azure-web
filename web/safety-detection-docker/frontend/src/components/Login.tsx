...
const Login = () => {
  ...
  useEffect(() => {
    const fetchCsrfToken = async () => {
      try {
        const response = await axios.get(`https://dockerwebs.azurewebsites.net/api/csrf_token/`, { withCredentials: true });
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      const response = await axios.post(`https://dockerwebs.azurewebsites.net/api/login/`, {
        id,
        password
      }, {
