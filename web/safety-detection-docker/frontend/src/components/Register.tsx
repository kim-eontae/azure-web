...
const Register = () => {
  ...
  const handleIdCheck = async () => {
    ...
    try {
      const response = await axios.post(`https://dockerwebs.azurewebsites.net/api/check_id/`, { id: formData.id }, {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await axios.post(`https://dockerwebs.azurewebsites.net/api/signup/`, submitData, {
        headers: {
          'Content-Type': 'application/json',
          'X-CSRFToken': csrfToken || ''
        }
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="input-group">
            ...
            <input 
              ...
              value={formData.guardian_phone_num}
              onChange={handleChange}
              className="input"
            />
          </div>
